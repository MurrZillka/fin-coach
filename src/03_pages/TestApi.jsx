...
// } from '../api/spendings';
// // --- ИМПОРТ ИЗ api/categories (имена должны совпадать с экспортом в api/categories/apiTypes.ts) ---
// // Убедись, что эти имена корректны. По твоему последнему коду api/categories/apiTypes.ts они такие:
// import {
